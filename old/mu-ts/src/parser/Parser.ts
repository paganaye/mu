...
import { MuParserError } from './Utils';
...
export class Parser {
    ...
    constructor(tokenizerOrScript: Tokenizer | string, readonly moduleName = 'main.Mu', readonly moduleType: BlockType = "module") {
    ...
    /**
     * Parses tokens and return Ast - Abstract Syntax Tree for Mu code
     * @param tokens tokens
    ...
    parseAstBlock(): AstBlock {
        try {
            ...
            throw new MuParserError(this.moduleName, token.startLine, token.startColumn,
